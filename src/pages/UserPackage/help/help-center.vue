 ...
 * @LastEditTime: 2019-08-12 16:01:07
 * @Description:
 -->
/*
        ...
        <div class="article-list">
            ...
            <ul class="list clearfix" v-if="articleList.length >0">
                ...
                >
                    <div class="cover">
                        <img
                            :src="filter.imgFilter(item.fileUrl,company_id, '100*100')"
                            :key="item.fileUrl"
                            lazy-load="true"
                        />
                    </div>
...
export default {
    ...
    methods: {
        ...
        routeLink(id) {
            this.$router.push(
                "/pages/UserPackage/help/article-detail?id=" + id
            );
        }
    }
};
