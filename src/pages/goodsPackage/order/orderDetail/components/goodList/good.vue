...
<template>
  <div class="good-wrap">
    ...
    <div class="good" @click.stop="viewGoodDetail()">
      <div class="imgBox">
        <img class="img-responsive" :src="filter.imgFilter(good.thumb,company_id)" alt />
      </div>
      <div class="good-info">
...
export default {
  ...
  methods: {
    ...
    applyPostSale() {
      ...
      this.$router.push("/pages/goodsPackage/afterSale/pages/apply/page");
    },
    ...
    viewPostSaleDetail() {
      ...
      if (num === 1) {
        this.$router.push({
          path: "/pages/goodsPackage/afterSale/pages/detail/page",
          query: {
        ...
        this.$router.push({
          path: "/pages/goodsPackage/afterSale/pages/list/page"
        });
      }
    },
