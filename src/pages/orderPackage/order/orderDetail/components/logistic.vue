<!--
 * @Author: lan.chen
 * @Date: 2019-08-01 18:14:25
 * @LastEditors: lan.chen
 * @LastEditTime: 2019-08-14 18:08:17
 * @Description: 
 -->
 ...
 * @Last Modified time: 2019-08-13 17:53:50
 * @Description: 物流进度组件
   @传入数据结构说明 
   data:{
 ...
 <template>
    <div class="logis-wrap" v-if="isReady">
        ...
        <div class="content overflow-scroll" v-if="!noResult">
            <van-steps direction="vertical" :steps="steps" :active="0" active-color="#000" />
        </div>
