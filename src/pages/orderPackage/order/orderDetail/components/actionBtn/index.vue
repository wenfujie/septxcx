 ...
 * @LastEditTime: 2019-08-01 15:32:14
 -->
...
export default {
    ...
    methods: {
        initState() {
            ...
            console.log(this.order.ordStatusCodes,'this.order.ordStatusCodesthis.order.ordStatusCodes')
        ...
        cancelOrder() {
            this.$store
                .dispatch("order/cancel", this.order.billCode)
                .then(() => {
        ...
        signUp() {
            this.$store
                .dispatch("order/signUp", this.order.billCode)
                .then(() => {
                    this.$store.dispatch("order/getOrderDetail").then(() => {
                        this.initState();
                    });
